window.resumeData = {
  ...
  projects: [
    {
      title:  "Mochi · macOS原生应用 — AI Native产品开发",
      role:   "独立开发与产品设计",
      period: "2026.05-2026.06",
      achievements: [
        {
          label: "项目背景",
          text: "验证一个假设：不会写很多代码的人，能不能用AI工具做出真正可用的产品？用Claude Code全程开发，从设计到上线一个人完成。"
        },
        {
          label: "关键产出",
          text: "（1）一个月内（非全职）从零搭建出功能完整的macOS原生应用——11个模块（日历/日程/随笔/待办/目标/印记/书影音/总览/分析/搜索/塔罗），覆盖记录→回顾→发现三层用户需求，全本地JSON+Markdown存储，5套视觉主题；（2）核心能力：不是代码速度，而是拆解复杂需求→向AI清晰描述任务和约束→验证输出质量→发现问题→调整描述→迭代这个AI Native工作流。这个工作模式可以直接迁移到'用AI辅助完成原型、文案、前端页面、用户路径分析和产品迭代'。"
        }
      ]
    },
    {
