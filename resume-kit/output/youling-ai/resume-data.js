window.resumeData = {
  ...
  projects: [
    ...
    {
      title:  "Mochi · macOS原生应用（人生叙事系统）",
      role:   "独立开发与产品设计",
      period: "2026.05-2026.06",
      achievements: [
        { label: "项目背景", text: "大多数效率工具关注「完成任务」，缺乏对人生轨迹的长期记录与回顾。Mochi定位为人生叙事系统：帮助用户记录、连接和发现自己的生活脉络。" },
        { label: "关键产出", text: "（1）设计并实现11个功能模块（日历/日程/随笔/待办/目标/印记/书影音/总览/分析/搜索/塔罗），覆盖记录→回顾→发现三层需求；（2）全本地JSON+Markdown存储，EventKit深度集成，5套视觉主题；（3）使用Claude Code独立完成全部开发，一个月内从设计到可运行应用，完整commit历史。核心能力：不是写代码速度，是知道如何拆解任务、描述需求、让AI替自己执行——即AI Native的工作方式。" }
      ]
    },
    {
      title:  "AI情感陪伴 · 策略备忘录",
